...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <link type="text/css" rel="stylesheet" href="/static/home/css/phb_style.css" />
    <!--[if IE 6]>
...
<title>天下白库排行榜——热销商品，折扣商品全品类排名信息实时发布！助您更省心更快捷购物！</title>
</head>
<body>
<!--Begin Header Begin-->
<div class="soubg">
...
<div class="top_block1">
    <div class="top_title">
        <h2 class="top_title_h2">白库推荐TOP 10</h2>
        <h3 class="top_title_h3">全站商品，一网打尽！更加超值，更多优惠！折上加折，惊喜不断！</h3>
    </div>
    <div class="top_body">
    <div class="top_goods">
        <a href="">
            @foreach()
            <div class="goods_smpic">
                <img src="" alt="" />
            </div>
