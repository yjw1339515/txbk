            ...
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="font-size:12px; padding-top:20px;">
                    ...
                    <span class="fr"><a id="555" href="#" style="color:#ff4e00;">忘记密码</a></span>
                </td>
              </tr>
              <tr height="60">
              	<td>&nbsp;</td>
...
<!--End Footer End -->    
 ...
 <script>
          $('#555').click(function(){
              layer.prompt({title: '请输入你绑定的邮箱账号', formType: 1}, function(pass, index)
              {
             
                
                  $.post('/home/login/email',{'_token':'{{csrf_token()}}','email':pass},function(res)
                  {
                      if(res=='ok'){
                          alert('成功');
